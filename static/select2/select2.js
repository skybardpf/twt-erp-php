...
(function ($, undefined) {
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
		...
		createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "       <input type='text' maxlength='65' autocomplete='off' class='select2-input'/>" ,
                "   </div>" ,
    ...
    $.fn.select2.defaults = {
        ...
        formatNoMatches: function () { return 'Соответствий не найдено' },
        ...
        formatSelectionTooBig: function (limit) { return "Вы можете выбрать только " + limit + " элемент" + (limit == 1 ? "" : "ов"); },
        formatLoadMore: function (pageNumber) { return "Подгружаются еще результаты..."; },
