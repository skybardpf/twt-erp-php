...
class DeleteAction extends CAction
{
    ...
    public function run($id, $type_lico, $org_id, $org_type, $date, $number_stake)
    {
        ...
        $model = InterestedPersonSecretary::model()->findByPk($id, $type_lico, $org_id, $org_type, $date, $number_stake, $controller->getForceCached());
            ...
            switch ($_POST['result']) {
                case 'yes':
                    if ($model->delete()) {
                        ...
                        throw new CHttpException(500, 'Не удалось удалить секретаря.');
                    }
                break;
                default:
