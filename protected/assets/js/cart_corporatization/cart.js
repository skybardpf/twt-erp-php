...
(function ($) {
        ...
        var that = {
            ...
            redraw: function () {
                ...
                particleSystem.eachEdge(function (edge, pt1, pt2) {
                    ...
                    ctx.fillStyle = "black";
                    ctx.font = "12px Helvetica";
                    ctx.fillText(edge.data.percent + "%", ((pt1.x + pt2.x) / 2) + 20, (pt1.y + pt2.y) / 2);
                });
            },
    ...
    $(document).ready(function () {
        ...
        // nodes
        for (i in raw_data) {
            data.nodes[raw_data[i].id1] = {color: raw_data[i].color1, type: raw_data[i].type1, label: raw_data[i].title1};
            data.nodes[raw_data[i].id2] = {color: raw_data[i].color2, type: raw_data[i].type2, label: raw_data[i].title2};
...
//        sys.parameters({stiffness:900, repulsion:1000, gravity:false, dt:0.015});
