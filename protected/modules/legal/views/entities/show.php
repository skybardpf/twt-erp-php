...
<div>
	...
	$this->widget('bootstrap.widgets.TbDetailView', array(
		...
		'attributes'=>array(
			...
			array('name' => 'country',      'label' => 'Страна юрисдикции', 'type' => 'raw', 'value' => $element->CountryValues[$element->country]),
			...
			array('name' => 'parent',       'label' => 'Группа контрагентов', 'type' => 'raw', 'value' => $element->parent ? $element->GroupNameValues[$element->parent] : 'Не указана'),
