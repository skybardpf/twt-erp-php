...
<?php $this->widget('bootstrap.widgets.TbMenu', array(
    ...
    'items'=>array(
        array('label'=>'Мои юридические лица', 'url'=>'/legal/my_legal_entities/', 'active'=> ($this->menu_current == 'index')),
        ...
        array('label'=>'Мои физические лица', 'url'=>'/legal/template_example/phiz/', 'active'=> ($this->menu_current == 'phiz')),
    ),
)); ?>
</div>