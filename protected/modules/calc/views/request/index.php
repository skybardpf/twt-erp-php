...
Yii::app()->clientScript->registerCssFile($this->module->baseAssets.'/select2/select2.css');

Yii::app()->clientScript->registerScriptFile($this->module->baseAssets.'/select2/select2.js');
Yii::app()->clientScript->registerScriptFile($this->module->baseAssets.'/js/calc.js');
