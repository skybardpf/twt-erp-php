...
/* Внимание Метод с ошибкой */ 'legal.Individual' => array('label' => 'Физические лица', 'url' => $this->createUrl('/legal/individuals/'), 'linkOptions' => array('style' => 'background: #f99', 'title' => 'Сущности с одинаковым id')),
