...
/* Внимание Метод с ошибкой */ 'legal.Individual' => array('label' => 'Физические лица', 'url' => $this->createUrl('/legal/individuals/'), 'linkOptions' => array('style' => 'background: #F22', 'title' => 'Сущности с одинаковым id')),
/* Внимание Метод с ошибкой */ 'legal.InterestedPerson' => array('label' => 'Заинтересованное лицо', 'url' => $this->createUrl('/legal/interested_persons/'), 'linkOptions' => array('style' => 'background: #F22', 'title' => 'Метод get не работает.')),
/* Внимание Метод с ошибкой */ 'legal.Beneficiary' => array('label' => 'Бенефициары', 'url' => $this->createUrl('/legal/beneficiary/'), 'linkOptions' => array('style' => 'background: #F22', 'title' => 'Записи с одинаковым id, метод get не работает.')),
